...
namespace Application\Sonata\Component\Transformer;
...
use Sonata\Component\Transformer\InvoiceTransformer as BaseInvoiceTransformer;

/**
 * @author Hugo Briand <briand@ekino.com>
 */
class InvoiceTransformer extends BaseInvoiceTransformer
{
    /**
    ...
    public function transformFromOrder(OrderInterface $order, InvoiceInterface $invoice)
    {
        ...
        $invoice->setPartitaIva($order->getBillingPartitaIva());
        $invoice->setCodiceFiscale($order->getBillingCodiceFiscale());
        ...
        $invoice->setProvincia($order->getBillingProvincia());
