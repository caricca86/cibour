...
use Sonata\Component\Transformer\BasketTransformer as BaseBasketTransformer;

class BasketTransformer extends BaseBasketTransformer
{
    /**
    ...
    public function transformIntoOrder(BasketInterface $basket)
    {
        ...
        if ($deliveryMethod->isAddressRequired()) {
            ...
            $order->setShippingProvincia($deliveryAddress->getProvincia());
        ...
        $order->setBillingProvincia($deliveryAddress->getProvincia());
