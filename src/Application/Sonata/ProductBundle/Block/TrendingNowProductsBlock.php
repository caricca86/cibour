...
use CTI\CibourBundle\Entity\Counter\TrendingNowCounter;
...
class TrendingNowProductsBlock extends BaseBlockService
{
     ...
     */
    public function __construct($name, EngineInterface $templating, RegistryInterface $registry, CurrencyDetectorInterface $currencyDetector, TrendingNowCounter $counter)
    {
